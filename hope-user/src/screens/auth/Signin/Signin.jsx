 ...
 * @description
 * An ultra-enhanced, animated authentication screen designed for a Mental Health & Wellness platform.
 * * Features include:
 * - **Visual Immersion:** Multi-layered `LinearGradient` header with `Animatable` entry sequences.
 * - **Smart Validation:** Real-time email and password checking with localized error feedback and shake animations.
 * - **Advanced UX:** `KeyboardAvoidingView` integration and sensitive toggle for password visibility.
 * - **Redux Integration:** Synchronous state management via `loginUser` thunk with comprehensive error handling for account locks or failed attempts.
 * - **Tactile Feedback:** Utilizes `react-native-toast-message` for granular, status-code-aware user notifications.
 */
